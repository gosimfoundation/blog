...
<template>
  <div class="py-5 bg-[#006d87] border-t dark:border-gray-800 mt-2 text-zinc-700 dark:text-zinc-300 text-2xl">
    <div class="px-6 container max-w-7xl mx-auto">
      ...
      <div class="border-t dark:border-gray-800 mt-5 text-center text-gray-200 text-lg p-2">
        © 2024
