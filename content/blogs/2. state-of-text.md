...
- Fontique uses `skrifa`.

However, it should be relatively easy to merge the libraries by implementing a superset of the enumeration methods and making use of feature-flagging to allow end-users to make their own trade-offs regarding dependency weight and enumeration fidelity. This would have the 
