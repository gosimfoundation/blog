...
If you are looking for a complete (or as close to complete as is available) high-level text stack in Rust today you really have two choice:

- A stack based cosmic-text stack (cosmic-text + rustybuzz + ttf_parser + fontdb + swash(scaling/hinting))
